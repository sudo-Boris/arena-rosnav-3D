...
class PedsimManager():
    def __init__(self):
        ...
        # spawn_interactive_obstacles_service_name = "pedsim_simulator/spawn_interactive_obstacles"
        # rospy.wait_for_service(spawn_interactive_obstacles_service_name, 6.0)
        # self.spawn_interactive_obstacles_client = rospy.ServiceProxy(
        #     spawn_interactive_obstacles_service_name, SpawnInteractiveObstacles)
