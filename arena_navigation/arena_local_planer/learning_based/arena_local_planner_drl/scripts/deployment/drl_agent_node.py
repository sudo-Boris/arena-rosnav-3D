...
TRAINED_MODELS_DIR = os.path.join(
    '/home/ignc/catkin_ws_3D/src/arena-rosnav-3D/arena_navigation/arena_local_planer/learning_based/arena_local_planner_drl', "agents"
)
DEFAULT_ACTION_SPACE = os.path.join(
    '/home/ignc/catkin_ws_3D/src/arena-rosnav-3D/arena_navigation/arena_local_planer/learning_based/arena_local_planner_drl',
    "configs",
